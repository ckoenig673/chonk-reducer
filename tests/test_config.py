...
def test_run_budget_reads_explicit_budget_value(monkeypatch):
    monkeypatch.setenv("RUN_BUDGET_TYPE", "estimated_savings_bytes")
    monkeypatch.setenv("RUN_BUDGET_VALUE", "1048576")
    monkeypatch.setenv("MAX_FILES", "6")
